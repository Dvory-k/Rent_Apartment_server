    ...
    //                 .then(() => {
                        let transporter = nodemailer.createTransport({
                            ...
                            auth: {
                                ...
                                key: 'AIzaSyD8ZBsa1hD6e4mz-D02FlKjIzESp5J7i1w'
                              // pass:'rent*1234'
                            }
                        });
                        let mailOptions = {
                        ...
                        // .try(()=>{
                        //   return res.status(200).send("sss")

                        // })
                        // .catch(()=>{
                        //   return res.status(400).send("lll")
                        // })
...
// module.exports = { userRegister, userLogin, getAllUsersById, deleteUserByAdmin }